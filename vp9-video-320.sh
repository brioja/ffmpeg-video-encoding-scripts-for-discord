...
nice -n 19 ffmpeg -y -i "$1" -vf scale=320:-1,fps=15 -fs 8000000 -b:v 150k -minrate 75k -maxrate 218k -tile-columns 0 -g 240 -threads 2 -quality good -crf 37 -c:v libvpx-vp9 -an -pass 1 -speed 4 "$1-compressed-320.webm" && \
nice -n 19 ffmpeg -y -i "$1" -vf scale=320:-1,fps=15 -fs 8000000 -b:v 150k -minrate 75k -maxrate 218k -tile-columns 0 -g 240 -threads 2 -quality good -crf 37 -c:v libvpx-vp9 -an -pass 2 -speed 1 "$1-compressed-320.webm"
